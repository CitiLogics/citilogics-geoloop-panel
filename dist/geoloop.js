    ...
    execute: function () {
      ...
      GeoLoop = function () {
        function GeoLoop(ctrl, mapContainer) {
          ...
          // colorbar
          d3.selectAll('#map_' + this.ctrl.panel.id + '_legend.bar').attr('background', 'linear-gradient(to right, ' + this.ctrl.theRamp(0) + ', ' + this.ctrl.theRamp(1) + ')');
          d3.selectAll('#map_' + this.ctrl.panel.id + '_legend.legend_text').html(this.ctrl.inputRange);
        }
